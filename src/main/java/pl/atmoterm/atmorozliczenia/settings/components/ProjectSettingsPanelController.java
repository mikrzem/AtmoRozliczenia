...
public class ProjectSettingsPanelController implements Initializable {
   ...
   public void initialize(URL url, ResourceBundle rb) {
      ...
      from.setCellValueFactory((param) -> param.getValue().getFromProperty());
      ...
      to.setCellValueFactory((param) -> param.getValue().getToProperty());
      ...
      id.setCellValueFactory((param) -> param.getValue().getIdProperty());
      id.setCellFactory(TextFieldTableCell.forTableColumn());
      id.setEditable(true);
      id.prefWidthProperty().bind(projectList.widthProperty().multiply(0.24));
      TableColumn<ProjectSettings, String> leader = new TableColumn<>("Kierownik");
      leader.setCellValueFactory((param) -> param.getValue().getLeaderProperty());
